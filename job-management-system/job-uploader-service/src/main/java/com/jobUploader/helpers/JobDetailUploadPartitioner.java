...
public class JobDetailUploadPartitioner implements Partitioner {
    ...
    public Map<String, ExecutionContext> partition(int gridSize) {
        ...
        for (Resource resource : resources) {
            ...
            String fileNameToPass = resource.getURL() != null ? resource.getURL().toString():null;

            context.putString(keyName, fileNameToPass);
